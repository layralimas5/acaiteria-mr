    ...
    <section id="montar" className="scroll-mt-24 bg-acai-50 py-20 sm:py-24">
      <div className="mx-auto max-w-6xl px-5">
        <div className="max-w-2xl">
          <span className="text-xs font-bold uppercase tracking-[0.18em] text-acai-700">Monte o seu</span>
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-3">
          {toppingGroups.map((group) => (
            <div key={group.title} className="rounded-card border border-acai-100 bg-white p-6">
              <h3 className="text-sm font-bold uppercase tracking-wide text-acai-800">{group.title}</h3>

    ...
    >
      <defs>
        <linearGradient id={`body-${label}`} x1="0" y1="0" x2="1" y2="1">
          <stop offset="0%" stopColor="#5c2c85" />
          <stop offset="55%" stopColor="#45215f" />
          <stop offset="100%" stopColor="#2e1640" />
        </linearGradient>
        <linearGradient id={`lid-${label}`} x1="0" y1="0" x2="1" y2="0">
          <stop offset="0%" stopColor="#a476d3" />
          <stop offset="100%" stopColor="#7239a5" />
        </linearGradient>
      </defs>

      <ellipse cx="100" cy="228" rx="62" ry="9" fill="#2e1640" opacity="0.12" />

      <path d="M42 58h116l-14 152a14 14 0 0 1-14 12.6H70a14 14 0 0 1-14-12.6L42 58Z" fill={`url(#body-${label})`} />
      <path d="M52 58h20l-10 164h-2a10 10 0 0 1-8-8L52 58Z" fill="#ffffff" opacity="0.08" />

      <rect x="36" y="42" width="128" height="26" rx="13" fill={`url(#lid-${label})`} />
      <ellipse cx="100" cy="42" rx="64" ry="12" fill="#c3a1e4" />
      <ellipse cx="100" cy="42" rx="48" ry="8" fill="#efe6f8" opacity="0.5" />
      ...
      <rect x="62" y="176" width="76" height="24" rx="12" fill="#ffffff" opacity="0.9" />
      <text x="100" y="193" textAnchor="middle" fontSize="13" fontWeight="700" fill="#45215f">
        {label}
      </text>
    </svg>
  )

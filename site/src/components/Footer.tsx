    ...
    <footer className="relative isolate overflow-hidden bg-acai-950 text-white">
      ...
      <div className="relative mx-auto grid max-w-6xl grid-cols-2 gap-x-4 gap-y-7 px-5 py-10 sm:gap-10 sm:py-14 lg:grid-cols-4">
        <div className="col-span-2 lg:col-span-2">
          ...
          <p className="mt-3 max-w-xs text-sm text-acai-100/70 max-sm:leading-[1.5] sm:mt-4">{business.tagline}</p>
        ...
        <nav aria-label="Links do rodapé">
          ...
          <ul className="mt-3 flex flex-col gap-0.5 text-sm sm:mt-4 sm:gap-3">
            {[
              ...
              <li key={link.href}>
                <a href={link.href} className="block py-2 text-acai-100/70 sm:py-0 transition-colors hover:text-white">
                  {link.label}
                </a>
              </li>
            ))}
        ...
        <div>
          ...
          <ul className="mt-3 flex flex-col gap-0.5 text-sm sm:mt-4 sm:gap-3">
            <li>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 py-2 text-acai-100/70 sm:py-0 transition-colors hover:text-white"
              >
                <WhatsAppIcon />
                {whatsappDisplay()}
              </a>
          ...
          <address className="mt-3 not-italic text-sm text-acai-100/70 max-sm:leading-[1.5] sm:mt-4">
      ...
      <div className="relative border-t border-white/10">
        <div className="mx-auto flex max-w-6xl flex-col gap-1.5 px-5 py-5 text-xs text-acai-100/60 max-sm:leading-[1.5] sm:flex-row sm:items-center sm:justify-between sm:py-6">
          <p>

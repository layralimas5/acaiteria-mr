...
/**
 * Artes da marca em rodízio.
 *
 * No celular a arte sangra de ponta a ponta, sem nada por cima, e o texto desce
 * para uma faixa escura logo abaixo: numa tela estreita, sobrepor cobriria
 * justamente os personagens e a logo que a ilustração já desenha.
 *
 * Do tablet para cima a arte vira um cartão centralizado, com o mesmo limite de
 * largura do resto do site, e o texto volta para dentro dela, no rodapé.
 */
        ...
        <div className="relative aspect-[4/3] max-h-[85vh] sm:aspect-[16/9] sm:max-h-[78vh]">
          <AnimatePresence initial={false}>
            <motion.div
              ...
              className="absolute inset-0 sm:art-fade"
            >
              <picture>

            ...
            <div>
              ...
              <p className="mt-4 max-w-md text-base leading-relaxed text-acai-100">
                {hasIfood()
                  ...
                  : 'Enquanto a loja no iFood não abre, o pedido sai pelo WhatsApp: você escolhe, a gente confirma e sai pra entrega.'}
              </p>
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center rounded-full border border-white/30 px-6 py-3 text-sm font-bold text-white transition-colors hover:bg-white/10"
                >
                  Pedir no WhatsApp
                </a>
              </div>

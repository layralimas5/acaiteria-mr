...
interface PixCodeProps {
  ...
  /** Referência no extrato da loja: o número do pedido, que já existe. */
  ...
  return (
    <div className="w-full rounded-2xl border border-acai-100 bg-acai-50/70 p-4 text-left">
      ...
      <p className="mt-1 text-xs leading-relaxed text-muted">
        ...
        Seu pedido já está na loja: depois de pagar, não precisa voltar aqui.
      </p>
      ...
      */}
      <p className="mt-1 text-xs leading-relaxed text-muted">
        ...
        {business.payments.pixHolder}. A loja reconhece pelo número {reference}, que vai junto no
        código. Se quiser, manda o comprovante no WhatsApp.
      </p>
    </div>
  )
}
